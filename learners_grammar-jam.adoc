...
* https://opengrammar.github.io/jam/gazetteer/[A Gazetteer of Placenames in Jamaican] (https://opengrammar.github.io/jam/gazetteer/gazetteer-jam.pdf[PDF])
...
See the accompanying _Gazetteer of Placenames in Jamaican_ for a list of common placenames and their pronunciation.
...
* Bryan, B. (2010). _Between two grammars: Research and practice for language learning and teaching in a Creole-speaking environment_. Kingston, Jamaica: Ian Randle Publishers.
